...
#mata-file::-webkit-file-upload-button {
  display:none;
}
hr{
...
$this->title = 'Kondisi Visual - Mata';
...
<div class="hidung-create">
   ...
   <?= $form->field($model, 'kondisi')->radioList( ['Tegas, tidak sayu'=>'Tegas, tidak sayu', 'Sayu, terlihat lemah' => 'Sayu, terlihat lemah'] ); ?>
 <hr>
...
<script>
    ...
    document.getElementById("mata-sapi_id").value= id_; 
    document.getElementById("mata-sapi_id").style.display= 'none'; 
    </script>