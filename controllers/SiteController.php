...
class SiteController extends Controller
{
    ...
    public function actionBacakonvi()
    {
        return $this->render('bacakonvi');
    }
    public function actionBacabcs()
    {
        return $this->render('bacabcs');
    }
    public function actionBacarike()
    {
        return $this->render('bacarike');
    }
    public function actionBacariva()
    {
        return $this->render('bacariva');
    }
    ...
    public function actionRegister()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if ($model->validate()) {
                ...
                if ($_POST['NewUser']['username'] != 'Admin'){
